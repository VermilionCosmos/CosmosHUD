"Resource/UI/HudMatchSummary.res"
{
	"MatchSummary"
	{
		...
		"ypos"			"0"
		"zpos"			"20"
		"visible"		"0" // Keep 0 or game crashes

		"AnimBluePlayerListParent"		"p.48" // p.47
		"AnimBluePlayerListParent"		"p.48" // p.47
		"AnimBlueTeamScore"				"p.47"
		"AnimBlueTeamScoreDropshadow"	"p.47"
		"AnimBlueTeamScoreBG"			"p.49"
		"AnimBluePlayerListBG"			"p.48"

		"AnimRedTeamScoreBGWide"			"p.49"
		"AnimRedTeamScoreBGXPos"			"r5-p.49"
		"AnimRedTeamScoreWide"				"p.47"
		"AnimRedTeamScoreXPos"				"r10-p.47"
		"AnimRedTeamScoreDropshadowWide"	"p.47"
		"AnimRedTeamScoreDropshadowXPos"	"r8-p.47"
		"AnimRedPlayerListParentWide"		"p.48"
		"AnimRedPlayerListParentXPos"		"r7-p.48"
		"AnimRedPlayerListBGWide"			"p.48"
		"AnimRedPlayerListBGXPos"			"r9-p.48"
		"AnimBlueMedalsYPos"				"110"
		"AnimRedMedalsYPos"					"110"
